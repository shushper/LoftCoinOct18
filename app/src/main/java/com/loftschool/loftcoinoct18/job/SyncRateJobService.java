...
//    private void showRateChangedNotification(CoinEntity newCoin, double priceDiff, Fiat fiat) {
//        Intent intent = new Intent(this, MainActivity.class);
//        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
//        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_ONE_SHOT);
//
...
//        notificationBuilder.setContentText(getString(R.string.notification_rate_changed_body, priceDiffString));
...
//        }
//
//        notificationManager.notify(newCoin.symbol, NOTIFICATION_ID_RATE_CHANGED, notificationBuilder.build());
